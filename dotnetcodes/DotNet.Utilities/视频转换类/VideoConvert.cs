...
namespace DotNet.Utilities
{
    ...
    public class VideoConvert : System.Web.UI.Page
    {
        ...
        {
            int i = fileName.LastIndexOf(@"\", System.StringComparison.Ordinal) + 1;
        ...
        public string CheckExtension(string extension)
        {
            ...
            if (strArrFfmpeg.Contains(extension)) m_strReturn = "ffmpeg";
            else if (strArrFfmpeg.Contains(extension)) m_strReturn = "mencoder";
    ...
    public string ChangeFilePhy(string fileName, string playFile, string imgFile)
    {
        ...
        System.Diagnostics.ProcessStartInfo FilestartInfo = new System.Diagnostics.ProcessStartInfo(ffmpeg)
        {
            ...
            Arguments = " -i " + fileName + " -ab 56 -ar 22050 -b 500 -r 15 -s " + widthOfFile + "x" + heightOfFile + " " + flv_file
        };
        try
        {
    ...
    public string CatchImg(string fileName, string imgFile)
    {
        ...
        {
            WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden,
            Arguments = "   -i   " + fileName + "  -y  -f  image2   -ss 2 -vframes 1  -s   " + FlvImgSize + "   " + flv_img
        };
        try
        {
    ...
    public string ChangeFileVir(string fileName, string playFile, string imgFile)
    {
        ...
        {
            WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden,
            Arguments = "   -i   " + fileName + "   -y   -f   image2   -t   0.001   -s   " + FlvImgSize + "   " + flv_img
        };
        System.Diagnostics.ProcessStartInfo FilestartInfo = new System.Diagnostics.ProcessStartInfo(ffmpeg)
        {
            WindowStyle = System.Diagnostics.ProcessWindowStyle.Hidden,
